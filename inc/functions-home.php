...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array(
			...
			array(
				'key'   => 'field_hero_slide2_tab',
				'label' => 'Hero — slide 2 (opcional)',
				'type'  => 'tab',
			),
			array(
				'key'          => 'field_hero2_imagen',
				'label'        => 'Slide 2 — imagen de fondo',
				'name'         => 'hero2_imagen',
				'type'         => 'image',
				'return_format'=> 'url',
				'preview_size' => 'medium',
			...
			array(
				'key'   => 'field_hero2_titulo',
				'label' => 'Slide 2 — título',
				'name'  => 'hero2_titulo',
				'type'  => 'text',
			),
			array(
				'key'   => 'field_hero2_subtitulo',
				'label' => 'Slide 2 — subtítulo',
				'name'  => 'hero2_subtitulo',
				'type'  => 'textarea',
				'rows'  => 2,
			),
			array(
				'key'   => 'field_hero2_boton_texto',
				'label' => 'Slide 2 — texto del botón',
				'name'  => 'hero2_boton_texto',
				'type'  => 'text',
			),
			array(
				'key'   => 'field_hero2_boton_url',
				'label' => 'Slide 2 — URL del botón',
				'name'  => 'hero2_boton_url',
				'type'  => 'url',
			),
			array(
				'key'   => 'field_hero_slide3_tab',
				'label' => 'Hero — slide 3 (opcional)',
				'type'  => 'tab',
			),
			array(
				'key'          => 'field_hero3_imagen',
				'label'        => 'Slide 3 — imagen de fondo',
				'name'         => 'hero3_imagen',
				'type'         => 'image',
				'return_format'=> 'url',
				'preview_size' => 'medium',
			...
			array(
				'key'   => 'field_hero3_titulo',
				'label' => 'Slide 3 — título',
				'name'  => 'hero3_titulo',
				'type'  => 'text',
			),
			array(
				'key'   => 'field_hero3_subtitulo',
				'label' => 'Slide 3 — subtítulo',
				'name'  => 'hero3_subtitulo',
				'type'  => 'textarea',
				'rows'  => 2,
			),
			array(
				'key'   => 'field_hero3_boton_texto',
				'label' => 'Slide 3 — texto del botón',
				'name'  => 'hero3_boton_texto',
				'type'  => 'text',
			),
			array(
				'key'   => 'field_hero3_boton_url',
				'label' => 'Slide 3 — URL del botón',
				'name'  => 'hero3_boton_url',
				'type'  => 'url',
			),
			array(
